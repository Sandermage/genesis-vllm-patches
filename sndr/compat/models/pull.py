...
"""Genesis models pull — `python3 -m vllm.sndr_core.compat.models.pull <key>`.
...
Usage:
  python3 -m vllm.sndr_core.compat.models.pull qwen3_6_27b_int4_autoround
  python3 -m vllm.sndr_core.compat.models.pull qwen3_6_27b_int4_autoround \
      --models-dir ~/models \
...
# Generated by: python3 -m vllm.sndr_core.compat.models.pull
# ════════════════════════════════════════════════════════════════════════
...
def _parse_args(argv=None):
    p = argparse.ArgumentParser(
        prog="python3 -m vllm.sndr_core.compat.models.pull",
...
def main(argv=None) -> int:
    ...
    if entry is None:
        ...
        print("Run `python3 -m vllm.sndr_core.compat.models.list` to see available models.",
              file=sys.stderr)
        return 2
