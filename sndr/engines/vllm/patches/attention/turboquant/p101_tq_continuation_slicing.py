...
- P56/P57 (TQ spec-decode dead-end workarounds) were archived 2026-05-05
  to Genesis_internal_docs/_archive/dead_patches/p56_p57_tq_specdec_deadends/.
  The earlier "P56 needs re-anchor against use_decode_continuation" TODO
  is moot — P56 no longer ships. Real spec-decode + TQ k8v4 fix lives
  in P65 (cudagraph downgrade) on a different code path.
