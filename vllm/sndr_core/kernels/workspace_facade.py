...
P98_ENV_FLAG = "GENESIS_ENABLE_P98_TQ_WORKSPACE_REVERT"
P99_ENV_FLAG = "GENESIS_ENABLE_P99_WORKSPACE_MANAGER_MEMOIZE"
PN118_ENV_FLAG = "GENESIS_ENABLE_PN118_TQ_WORKSPACE_FALLBACK"
...
class WorkspaceFacade:
    ...
    def decide_decode_path(
        ...
        On `GENESIS_ENABLE_P98_TQ_WORKSPACE_REVERT=1` and a decode call
    ...
    def decide_try_acquire(
        ...
        On `GENESIS_ENABLE_PN118_TQ_WORKSPACE_FALLBACK=1`, when
