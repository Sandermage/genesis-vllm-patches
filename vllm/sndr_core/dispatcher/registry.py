...
PATCH_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "G4_01": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_01_gemma4_ampere_fp8_block_guard",
        "lifecycle": "stable",
    ...
    "G4_02": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_02_gemma4_ampere_marlin_kdim_guard",
        "lifecycle": "stable",
    ...
    "G4_03": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_03_gemma4_ampere_non_causal_drafter_guard",
        "lifecycle": "stable",
    ...
    "G4_04": {
        ...
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_04_gemma4_awq_moe_keys_remap",
        "lifecycle": "stable",
    ...
    "G4_05": {
        ...
        "implementation_status": "full",
        "source": "vendor_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_05_gemma4_dflash_backend_autoselect",
        "lifecycle": "stable",
    ...
    "G4_06": {
        ...
        "implementation_status": "partial",
        "source": "vendor_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_06_gemma4_kv_proj_v_head_size_zero",
        "lifecycle": "experimental",
    ...
    "G4_07": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_07_gemma4_fp8_block_double_scale_fix",
        "lifecycle": "experimental",
    ...
    "G4_08": {
        ...
        "implementation_status": "partial",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_08_gemma4_marlin_kdim_pad_fallback",
        "lifecycle": "experimental",
    ...
    "G4_09": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_09_gemma4_swa_global_prefill_chunker",
        "lifecycle": "stable",
    ...
    "G4_10": {
        ...
        "implementation_status": "partial",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_10_gemma4_ampere_non_causal_attn_backend",
        "lifecycle": "experimental",
    ...
    "G4_11": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_11_gemma4_chat_template_install",
        "lifecycle": "stable",
    ...
    "G4_12": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_12_gemma4_fp8_e4nv_ampere_guard",
        "lifecycle": "stable",
    ...
    "G4_13": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_13_gemma4_per_token_head_kv_guard",
        "lifecycle": "stable",
    ...
    "G4_14": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_14_gemma4_tool_call_parser_pad_token",
        "lifecycle": "stable",
    ...
    "G4_15": {
        ...
        "implementation_status": "partial",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_15_gemma4_fused_rmsnorm_route",
        "lifecycle": "experimental",
    ...
    "G4_16": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_16_gemma4_full_piecewise_cudagraph",
        "lifecycle": "stable",
    ...
    "G4_17": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_17_gemma4_vision_tower_text_only_skip",
        "lifecycle": "experimental",
    ...
    "G4_18": {
        ...
        "implementation_status": "partial",
        "source": "vendor_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_18_gemma4_per_layer_kv_page_size",
        "lifecycle": "experimental",
    ...
    "G4_23": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_23_gemma4_vision_fp16_overflow_fix",
        "lifecycle": "stable",
    ...
    "G4_24": {
        ...
        "implementation_status": "partial",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_24_gemma4_fused_softcap_route",
        "lifecycle": "experimental",
    ...
    "G4_19": {
        ...
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_19_gemma4_turboquant_kv_cache",
        "lifecycle": "experimental",
    ...
    "G4_19B": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_19b_gemma4_tq_kv_spec_integration",
        "lifecycle": "experimental",
    ...
    "G4_60A": {
        ...
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60a_tq_sliding_window_spec",
        "lifecycle": "experimental",
    ...
    "G4_60E": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60e_kv_cache_utils",
        "lifecycle": "experimental",
    ...
    "G4_60G": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60g_attention_dispatch",
        "lifecycle": "experimental",
    ...
    "G4_60H": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60h_turboquant_config_augment",
        "lifecycle": "experimental",
    ...
    "G4_60C": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60c_triton_decode_overlay_loader",
        "lifecycle": "experimental",
        "credit": "Verifies triton_turboquant_decode.py bind-mount overlay from vllm PR #42637. Inspects triton_turboquant_decode_attention launcher signature for sliding_window + mm_prefix_range kwargs. Source: upstream_overlay_pr42637/triton_turboquant_decode.py (756 LOC).",
        "upstream_pr": "https://github.com/vllm-project/vllm/pull/42637",
        "requires_patches": [],
        "conflicts_with": [],
    ...
    "G4_60D": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60d_triton_store_overlay_loader",
        "lifecycle": "experimental",
        "credit": "Verifies triton_turboquant_store.py bind-mount overlay from vllm PR #42637. Store kernel changes minimal (+4/-4) — module-import verification only. Source: upstream_overlay_pr42637/triton_turboquant_store.py (447 LOC).",
        "upstream_pr": "https://github.com/vllm-project/vllm/pull/42637",
        "requires_patches": [],
        "conflicts_with": [],
    ...
    "G4_61": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_61_tq_shared_workspace",
        "lifecycle": "experimental",
    ...
    "G4_71": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_71_drafter_native_attn_backend",
        "lifecycle": "experimental",
    ...
    "G4_72": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_72_drafter_native_kv_cache_spec",
        "lifecycle": "experimental",
    ...
    "G4_76": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_76_disable_drafter_kv_sharing",
        "lifecycle": "experimental",
    ...
    "G4_75": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_75_drafter_head512_triton",
        "lifecycle": "experimental",
    ...
    "G4_74": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_74_drafter_hnd_layout",
        "lifecycle": "experimental",
    ...
    "G4_73": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_73_drafter_profile_skip",
        "lifecycle": "experimental",
    ...
    "PN262B": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.pn262b_kv_alloc_trace",
        "lifecycle": "experimental",
    ...
    "PN262": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.pn262_flash_attn_drafter_trace",
        "lifecycle": "experimental",
    ...
    "G4_69": {
        ...
        "implementation_status": "experimental",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_69_skip_layers_native_backend",
        "lifecycle": "experimental",
    ...
    "G4_67": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_67_tq_spec_verify_routing",
        "lifecycle": "experimental",
    ...
    "G4_62": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_62_tq_kernel_warmup",
        "lifecycle": "experimental",
    ...
    "G4_60K": {
        ...
        "implementation_status": "experimental",
        "source": "upstream_backport",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_60k_arg_utils",
        "lifecycle": "experimental",
    ...
    "G4_25": {
        ...
        "implementation_status": "full",
        "source": "genesis_original",
        "apply_module": "vllm.sndr_core.integrations.gemma4.g4_25_gemma4_rope_dual_base_freq_guard",
        "lifecycle": "stable",
