...
UPSTREAM_DRIFT_MARKERS = [
    # If PR #39908 ever merges, the file will contain a comment like
    # "# Cast bf16 to fp16 first" or the explicit float16 cast.
    "tl.float16).to(tl.float8e4b15)",  # any form of the fix already present
    "PR #39908",
]
