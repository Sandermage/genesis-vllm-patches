...
export const RESPONSES: Record<string, unknown> = {
  ...
  deployPlan: { preset_id: "", preset_label: "", target: "compose", target_label: "Docker Compose", artifact: { kind: "yaml", filename: "docker-compose.yml", content: "" }, parameters: {}, mount_vars: [], dependencies: { is_ready: true, n_blockers: 0, n_warnings: 0, items: [] }, commands: [] },
  installTargets: { targets: [], hosts: [], apply_enabled: false },
  jobs: { jobs: [] },
...
export const URL_TABLE: Array<[string, string]> = [
  ...
  ["/api/v1/deploy/plan", "deployPlan"],
  ["/api/v1/deploy/targets", "deployTargets"],
  ["/api/v1/install/targets", "installTargets"],
  ["/api/v1/jobs", "jobs"],
