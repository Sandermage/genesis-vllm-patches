...
import { formatTokens, formatVram, totalVramGiB } from "./lib/format";
import { StatusBadge, StatusPill, InfoRows, CompactList, KpiGrid, CapChip, RailCheck, type GateStatus } from "./components/primitives";
...
// CapChip extracted to ./components/primitives; totalVramGiB to ./lib/format.
