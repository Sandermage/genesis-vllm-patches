...
SPEC_DECODE_PATCHES = [
    ("vllm.sndr_core.integrations.spec_decode.p70_auto_strict_ngram", "P70"),
    ("vllm.sndr_core.integrations.spec_decode.p71_block_verify", "P71"),
    ("vllm.sndr_core.integrations.spec_decode.p75_suffix_decoding_enable", "P75"),
    ("vllm.sndr_core.integrations.spec_decode.p77_adaptive_ngram_k", "P77"),
    ("vllm.sndr_core.integrations.spec_decode.p82_sglang_acceptance_threshold", "P82"),
    ("vllm.sndr_core.integrations.spec_decode.p86_ngram_batch_propose_linear", "P86"),
    ("vllm.sndr_core.integrations._retired.p94_spec_decode_zero_alloc", "P94"),
    ("vllm.sndr_core.integrations._retired.pn9_independent_drafter_attn_backend", "PN9"),
    ("vllm.sndr_core.integrations.spec_decode.pn21_dflash_swa_support", "PN21"),
    ("vllm.sndr_core.integrations.spec_decode.pn22_local_argmax_tp", "PN22"),
    ("vllm.sndr_core.integrations.spec_decode.pn23_dflash_combine_hidden_dtype", "PN23"),
    ("vllm.sndr_core.integrations.spec_decode.pn38_dflash_quant_drafter", "PN38"),
