...
**Total PATCH_REGISTRY entries:** 279 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **279** |
...
| Implementation status=full | 219 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 8 + 4) |
| Apply-loop coverage (apply_module set) | 257 / 279 = 92.0% |
