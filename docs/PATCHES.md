...
**Total PATCH_REGISTRY entries:** 307 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **307** |
| Tier=community (Apache 2.0, sndr) | **307** (all entries) |
...
| Implementation status=full | 247 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 8 + 4) |
| Apply-loop coverage (apply_module set) | 285 / 307 = 92.8% |
