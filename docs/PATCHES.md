...
**Total PATCH_REGISTRY entries:** 278 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **278** |
...
| Implementation status=full | 218 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 8 + 4) |
| Apply-loop coverage (apply_module set) | 256 / 278 = 92.0% |
