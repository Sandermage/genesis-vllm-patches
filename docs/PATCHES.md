...
**Total PATCH_REGISTRY entries:** 312 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **312** |
...
| Implementation status=full | 252 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 8 + 4) |
| Apply-loop coverage (apply_module set) | 290 / 312 = 92.9% |
