...
**Total PATCH_REGISTRY entries:** 321 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **321** |
...
| Implementation status=full | 261 |
| Implementation status=marker_only / placeholder / partial / retired | 35 (20 + 2 + 7 + 6) |
| Apply-loop coverage (apply_module set) | 299 / 321 = 93.1% |
