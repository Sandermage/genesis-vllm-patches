...
> Genesis `v12.0.0` (279 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 279 small surgical
...
The patch registry is the heart of Genesis. 279 entries live in
