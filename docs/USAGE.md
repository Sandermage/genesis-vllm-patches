...
> Genesis `v12.0.0` (240 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 240 small surgical
...
The patch registry is the heart of Genesis. 240 entries live in
