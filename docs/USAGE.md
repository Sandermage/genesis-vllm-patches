...
> Genesis `v12.0.0` (278 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 278 small surgical
...
The patch registry is the heart of Genesis. 278 entries live in
