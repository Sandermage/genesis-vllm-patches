...
> Genesis `v12.0.0` (237 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 237 small surgical
...
The patch registry is the heart of Genesis. 237 entries live in
