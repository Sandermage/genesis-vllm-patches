...
> Genesis `v12.0.0` (307 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 307 small surgical
...
The patch registry is the heart of Genesis. 307 entries live in
