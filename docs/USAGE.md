...
> Genesis `v12.0.0` (252 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 252 small surgical
...
The patch registry is the heart of Genesis. 252 entries live in
