...
> Genesis `v12.0.0` (316 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 316 small surgical
...
The patch registry is the heart of Genesis. 316 entries live in
