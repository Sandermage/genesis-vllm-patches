...
> Genesis `v12.0.0` (280 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 280 small surgical
...
The patch registry is the heart of Genesis. 280 entries live in
