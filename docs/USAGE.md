...
> Genesis `v12.0.0` (236 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 236 small surgical
...
The patch registry is the heart of Genesis. 236 entries live in
