...
> Genesis `v12.0.0` (314 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 314 small surgical
...
The patch registry is the heart of Genesis. 314 entries live in
