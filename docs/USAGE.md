...
> Genesis `v12.0.0` (298 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 298 small surgical
...
The patch registry is the heart of Genesis. 298 entries live in
