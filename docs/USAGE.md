...
> Genesis `v12.0.0` (318 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 318 small surgical
...
The patch registry is the heart of Genesis. 318 entries live in
