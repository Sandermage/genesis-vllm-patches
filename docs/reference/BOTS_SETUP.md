...
- **What it does**: Static analysis on Python code (vllm/sndr_core/, genesis_*.py, tools/external_probe/) on every push to `main`, every PR touching those paths, and weekly Monday at 06:00 UTC.
