...
| **PN358** | `community` | `experimental` | · | `GENESIS_ENABLE_PN358_FULL_CG_CONTEXT_REFRESH` | [#44868](https://github.com/vllm-project/vllm/pull/44868) | FULL cudagraph forward-context refresh, data_ptr-pruned (vendor of vllm#44868) |
...
| ID | Tier | Lifecycle | Default | Env flag | Upstream PR | Title |
|---|---|---|:---:|---|:---:|---|
| **PN296** | `community` | `experimental` | · | `GENESIS_ENABLE_PN296_ARCH_PROFILE_INIT` | — | Genesis GPU Architecture Profile boot-time initializer (auto-tune env by arch) |
...
| **PN352B** | `community` | `experimental` | · | `GENESIS_ENABLE_PN352B_MARLIN_MOE_SUM` | [#44557](https://github.com/vllm-project/vllm/pull/44557) | Marlin MoE topk=8 reduce via Genesis Triton kernel (right call-site for the F... |
...
| **PN371** | `community` | `experimental` | · | `GENESIS_ENABLE_PN371_ENCODER_CACHE_EVICTION` | [#45199](https://github.com/vllm-project/vllm/pull/45199) | Deferred ref-pinned encoder-cache eviction (vendor of CLOSED vllm#45199) |

### `observability` (6)

| ID | Tier | Lifecycle | Default | Env flag | Upstream PR | Title |
|---|---|---|:---:|---|:---:|---|
| **P88** | `community` | `experimental` | · | `GENESIS_ENABLE_P88_PREFIX_CACHE_STATS_DEDUP` | [#45202](https://github.com/vllm-project/vllm/pull/45202) | Prefix-cache stats retry de-duplication (rewrite of vllm#45202) |
...
| **PN391** | `community` | `experimental` | · | `GENESIS_ENABLE_PN391_HEALTH_DECODE_WATCHDOG` | [#45453](https://github.com/vllm-project/vllm/pull/45453) | /health/decode forward-progress watchdog (vendor of vllm#45453) |
...
| **P89** | `community` | `experimental` | · | `GENESIS_ENABLE_P89_REASONING_TOKENS_USAGE` | [#45471](https://github.com/vllm-project/vllm/pull/45471) | completion_tokens_details.reasoning_tokens in chat usage (vendor of vllm#45471) |
...
| **PN348** | `community` | `experimental` | · | `GENESIS_ENABLE_PN348` | [#44644](https://github.com/vllm-project/vllm/pull/44644) | Qwen3.5/3.6 MTP backbone dedup (vendor of OPEN vllm#44644) — ~1 GiB/rank peak... |
